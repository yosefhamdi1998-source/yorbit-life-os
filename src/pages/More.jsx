      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
        {items.map(({ path, icon: Icon, label }) => (
          <NavLink
            key={path}
            to={path}
            className="flex flex-col items-center justify-center gap-2 bg-card border border-border rounded-2xl py-6 px-3 text-center transition-transform active:scale-95"
          >
